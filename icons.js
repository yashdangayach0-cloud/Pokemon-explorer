var icons = {
  ...
  search:
    '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="#dc0a2d" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">' +
      '<circle cx="10.5" cy="10.5" r="7"/>' +
      '<line x1="16" y1="16" x2="22" y2="22"/>' +
    '</svg>',

  cross:
    '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="#666" stroke-width="2.5" stroke-linecap="round">' +
      '<line x1="18" y1="6" x2="6" y2="18"/>' +
      '<line x1="6" y1="6" x2="18" y2="18"/>' +
    '</svg>',

  sorting:
    '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="#dc0a2d" stroke-width="2.5" stroke-linecap="round">' +
  ...
  backToHome:
    '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="28" height="28" fill="none" stroke="white" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">' +
